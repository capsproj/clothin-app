...
class ProductPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar:
          AppBar(title: const Text('List of Available Products'), actions: []),
            ...
            child: SizedBox(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  final product = products[index]; // this line
                  return MyProductTile(
                      product:
                          product); // up to this line should be replace by the products that is on the database
                },
              ),
            ),
          ),
